...
![Version: 0.1.14](https://img.shields.io/badge/Version-0.1.14-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.5.2](https://img.shields.io/badge/AppVersion-2.5.2-informational?style=flat-square)
...
```bash
helm upgrade --install prowlarr . \
  -n prowlarr --create-namespace \
  -f values.yaml
```
...
```bash
helm upgrade --install prowlarr k8s-mediaserver-charts/prowlarr \
  -n prowlarr --create-namespace \
  -f values.yaml
```
...
```bash
helm uninstall prowlarr -n prowlarr
```
